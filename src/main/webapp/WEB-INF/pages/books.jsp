...
<head>
    ...
    <style>
        body {
            background: url(https://st3.depositphotos.com/13349494/18229/i/450/depositphotos_182297550-stock-photo-flat-lay-eucalyptus-blank-paper.jpg); /* Цвет фона и путь к файлу */
...
<section>
    ...
    <form action="/add-book" method="post">
        ...
        <h2 style="color: slategray" align="center"><b>ADD NEW BOOK</b></h2>
